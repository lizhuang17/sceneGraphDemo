...
export class SceneManager{
    constructor(viewer){
		...
		this.fistVDList = [3465,2804,2839,3547,3097,2816,3546,3548,3475,3474,2870,2880,2518,2805,2860,2819,2848,2858,3132,2828,2818,2893,2847,2829,2896,2803,2894,2842,2807,2871,2881,3120,2830,2859,2817,2869,2841,2849,2806,2882,2576,2904,3134,2897,3489,2895,2892,3112,2949,2502,3556,3133,2930,2898,2957,3486,741,744,728,3131,2105,3498,2045,2041,2899,2840,2951,730,732,2905,2932,3539,2667,2094,2597,2512,2038,3542,2519,2562,3558,2825,2814,3535,3533,3480,2081,2106,2101,2952,2795,2534,2900,2539,2585,2833,2824,2823,2831,2813,2808,2826,2815,2838,3527,40,2249,738,3275,2498,726,3497,3259,3148,2148,2486,737,2959,2798,2043,2071,736,2514,2080,2681,2108,3485,2091,2305,2084,2085,2516,2517,2117,2515,3492,2532,2531,2575,2529,2528,2520,2574,748,2832,3553,1225,2851,2845,2837,2843,2865,2822,2857,2821,2812,2835,2820,2811,2834,2846,2844,2827,2853,2887,2863,2810,2809,2886,2868,2850,2883,2864]
        ...
        const self=this
        for(let i=0;i<self.fistVDList.length&&i<1;i++){
            self.loadModelZip(self.fistVDList[i])
        }
        setInterval(()=>{
            for(let i=1;i<self.fistVDList.length&&i<30;i++){
                self.loadModelZip(self.fistVDList[i])
            }
        },1000)
        setInterval(()=>{
            for(let i=30;i<self.fistVDList.length&&i<100;i++){
                self.loadModelZip(self.fistVDList[i])
            }
        },1500)
        new DynamicLoading({
...
function processMesh(mesh,matrixList){
    ...
    material.side=0
    // material.transparent=mesh.material.transparent//false
